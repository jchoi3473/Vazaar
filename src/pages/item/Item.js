    ...
    return(
        <div className = "Vazaar-Item-Container">
            <div className = "Vazaar-Item-Left">
                <div className = "Vazaar-Item-Picture-Container" style = {{height: '68%'}}>
            ...
            <div className = "Vazaar-Item-Right">
                ...
                <div style = {{height: '23rem', display: 'flex', flexDirection:'column', justifyContent:"space-evenly"}}>
                ...
                <div style = {{height: '10rem', display: 'flex', flexDirection:'column', justifyContent:"space-evenly", marginTop:'15px'}}>
