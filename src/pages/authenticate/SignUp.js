            ...
            <div className = "Vazaar-SignUp-Container">
                ...
                <div className = "Vazaar-SignUp-Form-Container">
                    ...
                    <div className = "Vazaar-SignUp-Form-SubContainer">
                        ...
                        <FormInput placeholder = "Enter emory.edu Email" />
                    </div>
                    <div className = "Vazaar-SignUp-Form-SubContainer">
                        <div className = "Vazaar-SignUp-Form-SecondTitle">
                            CITY
                ...
                <div className = "Vazaar-SignUp-Button-Container" style ={{"marginTop":"70px"}}>
                    <BlueButton text = "Sign Up" width = "417px" height = "47px"/>
                    <div style ={{"marginTop":"28px"}}>
                        <div className = "Vazaar-Roboto-normal" style = {{"display":"inline-block", "fontSize":"14px"}}>
                            Already have an account?
                        </div>
                        <div className = "Vazaar-Roboto-normal" style = {{"display":"inline-block", "fontSize":"14px", "color":"#11A1FD", "cursor":"pointer", "marginLeft":"5px"}} onClick = {onClickSignIn}>
                            Sign In
                        </div>
                    </div>
                </div>
